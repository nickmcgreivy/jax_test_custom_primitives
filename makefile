...
sparse_solve:
	c++ -O3 -Wall -shared -std=c++11 -undefined dynamic_lookup -I eigen-3.4.0/ `python3 -m pybind11 --includes` sparse_solve_prim/sparse_solve.cpp -o sparse_solve_prim/eigensolve`python3-config --extension-suffix`
